  ...
  return (
    <main className="mt-12 flex w-full flex-1 flex-col items-center px-4 text-center">
      ...
      <h1 className="md:text-6xl text-3xl font-regular tracking-tight mb-6 mt-6">
        ...
        <br />
        <span className="text-[#3ABEF9]">Instantly</span> with AI 🤖
      </h1>

      <p className="md:text-xm text-sm text-muted-foreground mb-6">
        Just describe what you want and the AI will generate the code for you.
      </p>
        ...
        <div className="relative w-full">
          <form onSubmit={createApp}>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="absolute right-1 top-1 bg-[#3ABEF9] hover:bg-[#3572EF] text-black h-10"
            >
              Start Building
            </Button>
          </form>
